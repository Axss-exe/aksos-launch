...
const needs = ['Investment opportunities', 'Funding opportunities', 'Local partners', 'Organizations', 'Businesses', 'Government / institutional contacts', 'Specialists / expertise', 'Projects', 'Market information', 'Regulatory information', 'Other']
const stages = [ 
...
export function BatanaPage() { 
  ...
  return <main className="batana-page" id="top">
    ...
    <section className="batana-hero-v2">
      <div className="batana-hero-overlay" />
      <div className="batana-hero-copy">
        <p className="eyebrow">PROJECT BATANA</p>
        <h1>You know what you want to do in Zimbabwe.<br /><em>But you may not know who can help you do it.</em></h1>
        <div className="batana-hero-body">
      ...
      <div className="batana-hero-index">
        EARLY PILOT<br />
        <span>OBJECTIVE  CONNECTION</span>
      </div>
    </section>
    
    <section className="batana-chapter">
      <Label>01 / THE PROBLEM</Label>
      <h2>The information you need may not be online.</h2>
      <div className="batana-copy">
      ...
      <p className="batana-callout">
        But you don&apos;t need to map Zimbabwe before you can start.<br />
        <em>You need to tell us what you&apos;re trying to accomplish.</em>
      </p>
    </section>
    
    <section className="batana-flow">
      <Label>02 / SEARCHING VS FINDING</Label>
      <h2>The visitor starts with an objective,<br /><em>not with a contact list.</em></h2>
      <div className="flow-diagram">
        <div className="flow-track searching">
          <h3>SEARCHING ALONE</h3>
          {['Your objective', 'Google', 'Reports', 'Websites', 'Emails', 'Cold introductions', 'Unknown information'].map((item) => 
            <div className="flow-node" key={item}>{item}<span></span></div>
          )}
          <strong>Who actually knows?</strong>
        </div>
        <div className="flow-divider">OR</div>
        <div className="flow-track finding">
          <h3>PROJECT BATANA</h3>
          {['Your objective', 'Understand what you need', 'Identify relevant people & organizations', 'Investigate potential matches', 'Assess relevance', 'Find the right connection'].map((item) => 
            <div className="flow-node" key={item}>{item}<span></span></div>
          )}
    ...
    <section className="batana-chapter objective">
      <Label>03 / YOUR OBJECTIVE</Label>
      <h2>Start with your vision.<br /><em>Not your search history.</em></h2>
      <div className="batana-copy">
      ...
      <div className="objective-list">
        {['I want to invest in Zimbabwe.', 'I want to fund a high-impact project.', 'I want to build something.', 'I want to find a local implementation partner.', 'I want to expand an existing organization.', 'I have an idea, but I don\'t know who could make it possible.'].map((item) => 
          <p key={item}>{item}</p>
        )}
      </div>
      <p className="batana-callout">Your objective is the starting point.</p>
    </section>
    
    <section className="batana-dark-v2" id="how">
      <Label>04 / HOW BATANA WORKS</Label>
      <h2>We do not start by searching for random people.</h2>
      <p className="wide-copy">We start by understanding what you are trying to accomplish. Then we move through context, requirements, discovery, validation, and connection.</p>
      <div className="batana-process-v2">
        {stages.map(([number, title, copy], i) => 
          <div className={i === 0 ? 'process-node first' : 'process-node'} key={number}>
            <span>{number}</span>
            <h3>{title}</h3>
            <p>{copy}</p>
      ...
      <p className="batana-outcome">The outcome may be a conversation, a partnership, a project, an investment, or a new relationship. We do not promise the final outcome.</p>
    </section>
    
    <section className="batana-chapter difference">
      <Label>05 / THE DIFFERENCE</Label>
      <h2>We don&apos;t just give you a list of names.</h2>
      <div className="batana-copy">
      ...
      <div className="match-diagram">
        <div><span>YOUR OBJECTIVE</span><b>What you want to accomplish</b></div>
        <i></i>
        <div><span>WHAT YOU NEED</span><b>Capital  Expertise  Local knowledge  Implementation  Relationships</b></div>
        <i></i>
        <div><span>FIT</span><b>Relevant? Credible? Capable? Aligned?</b></div>
        <i></i>
        <div className="match-result"><span>CONNECTION</span><b>A relevant conversation</b></div>
      </div>
      <p className="batana-callout">
    ...
    <section className="batana-pilot">
      <div>
        <Label>06 / PROJECT BATANA</Label>
        <h2>We don&apos;t want everyone.</h2>
    ...
    <section className="batana-apply-v2" id="apply">
      <div className="apply-copy">
        <Label>07 / APPLY</Label>
        <h2>Tell us what you&apos;re trying to accomplish.</h2>
        <p>You don&apos;t need to know who you need to talk to. You just need to know what you want to make happen.</p>
      </div>
      <form className="batana-form" onSubmit={submit}>
    ...
    <section className="batana-final-v2">
      <p className="eyebrow">PROJECT BATANA</p>
      <h2>Your idea is only the beginning.</h2>
      <p>You may already know exactly what you want to do. But the right people may still be missing.</p>
      <p className="final-motto">Real intentions. Real relationships. Real possibilities.</p>
    </section>
    <footer>
      <a href="/#top" className="wordmark">
        <img className="brand-mark brand-mark-small" src="/aksos-symbol-traced.svg" alt="" />
