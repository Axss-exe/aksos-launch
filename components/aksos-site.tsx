  ...
  return (
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-aside"><div className="hero-wordmark"><img src="/aksos-wordmark.svg" alt="AKSOS" /></div><div className="status"><span className="status-dot" />Early stage · Building in public</div></div>
      </section>
